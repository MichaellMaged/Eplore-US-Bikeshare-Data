...
def get_filters():
    ...
    while True:
        ...
        if city in ('chicago','new york','washington'):
            print('\nYou Chose {} City.'.format(str.capitalize(city)))
            break
        else:
            print('\nPlease Choose from the Aforementioned Cities !\n')
...
def time_stats(df):
    ...
    month_dic={1:'January',2:'February',3:'March',4:'April',5:'May',6:'June',7:'July',8:'August',9:'September',10:'October',11:'Novermber',12:'December'}
...
def user_stats(df):
    ...
    #Keyerror checking as Gender data is not available in washington dataset
    try:
    ...
    #Keyerror checking as Birth Year data is not available in washington dataset
    try:
